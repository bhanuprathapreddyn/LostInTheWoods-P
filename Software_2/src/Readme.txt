Final Project:
You have to make oggy find jack....
...
How to control:
  Jack(user 1):    is able to press keyboard "w", "s", "a", "d" to move up, down, left, right
  Oggy(user 2):  is able to press keyboard up, down, left, right to move up, down, left, right
...
Game Finish Requirement:
    dual player mode:   When Jack sees Oggy, game is over and a celebration screen will be displayed with the celebration sound
    3 player mode:      When Jack meets both Oggy and sandy, game is over and a celebration screen will be displayed with the celebration sound
    4 player mode:      When Jack meets both Oggy, squid and sandy, game is over and a celebration screen will be displayed with the celebration sound
  
Bump into the wall:
  Jack/Oggy/Sandy/Squid don't have superpower so if they hit the wall they will be forced to go back to recent position with a collision sound
